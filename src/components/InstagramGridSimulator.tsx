...
export default function InstagramGridSimulator({ projects, onSelectProject }: InstagramGridSimulatorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 w-full">
      {/* Outer iPad Container */}
      <div 
        className="relative mx-auto w-full max-w-[620px] aspect-[3/4] rounded-[36px] border-[16px] border-[#1e1e24] bg-[#050508] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col"
        style={{
          boxShadow: '0 25px 60px -15px rgba(0,0,0,0.9), 0 0 0 1px rgba(255,255,255,0.05), inset 0 0 15px rgba(255,255,255,0.05)'
        }}
      >
        {/* iPad Camera Dot in top bezel */}
        ...
        <div className="flex-1 overflow-y-auto pt-4 scrollbar-none flex flex-col bg-[#050508] select-none text-left" dir="ltr">
          ...
          <div className="px-4 pt-4 pb-2">
            ...
            <div className="mt-3 text-left">
              ...
              <p className="text-[10px] text-gray-300 mt-1 leading-relaxed whitespace-pre-wrap">
            ...
            <div className="flex gap-2 mt-4 text-center">
              <a 
                ...
                className="flex-1 py-1.5 rounded-lg bg-[var(--color-accent-blue)] hover:opacity-90 text-white text-[11px] font-bold transition-all text-center flex items-center justify-center cursor-pointer"
              >
                Follow
              </a>
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex-1 py-1.5 rounded-lg bg-white/10 hover:bg-white/15 text-white text-[11px] font-bold border border-white/5 transition-all text-center flex items-center justify-center cursor-pointer"
              >
                Message
              </a>
            </div>
